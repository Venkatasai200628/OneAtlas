...
export default function InvitePage() {
  ...
  const handleSend = () => {
    ...
    const subject = encodeURIComponent('Join me on One Atlas — AI App Generator');
    const body = encodeURIComponent(
      `Hey! I've been using One Atlas to generate app schemas with a 3-stage AI pipeline.\n\nCheck it out: ${referralLink}\n\n— ${user?.displayName || 'Your friend'}`
    );
    ...
    <div className="h-full overflow-auto bg-slate-50 dark:bg-slate-900">
      ...
      <div className="max-w-xl mx-auto p-5 space-y-4">
        ...
        <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-6 text-white text-center">
          ...
          <p className="text-indigo-200 text-sm">Share One Atlas with teammates and collaborate on app schemas.</p>
        </div>
